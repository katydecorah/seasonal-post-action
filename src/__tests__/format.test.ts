...
export const { recipeYaml, recipeText } = formatRecipes({
  recipeData: recipes,
  start: "2021-09-21",
  end: "2021-12-20",
});
...
export const { playlistYaml, playlistText } = formatPlaylist({
...
export const { bookYaml, bookText } = formatBooks({
  bookData: books,
  start: "2021-09-21",
  end: "2021-12-20",
});
...
export const frontmatter = formatFrontMatter({
  year: 2021,
  season: "Fall",
  image: "",
  bookYaml,
